...
export default function QuizIniciarComponent() {
    return (
      <div className="flex h-full w-full items-center justify-center bg-azul-b3 opacity-80">
        <div className="flex flex-col w-1/3 items-center gap-10">
          ...
          <button className="bg-yellow-300 w-40 hover:bg-amarelo-b3 text-gray-800 text-lg font-sans p-4 rounded-lg mt-4">
            Iniciar o Quiz
          </button>
          </Link>
        </div>
